...
const COMBINED_ITEMS = {
    ...
    'bow+bow': { name: 'Rapid Firecannon', img: CDN_BASE + 'tft_item_rapidfirecannon.tft_set13.png' },
    ...
    'tear+belt': { name: 'Spirit Visage', img: CDN_BASE + 'tft_item_spiritvisage.tft_set13.png' },
